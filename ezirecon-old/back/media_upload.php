...
class media_upload extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->setPath_img_upload_folder("assets/img/media/");
        $this->setPath_img_thumb_upload_folder("assets/img/media/thumbnails/");

        //Delete img url
        $this->setDelete_img_url(base_url() . 'admin/deleteImage/');

        //Set url img with Base_url()
        $this->setPath_url_img_upload_folder(base_url() . "assets/img/media/");
        $this->setPath_url_img_thumb_upload_folder(base_url() . "assets/img/media/thumbnails/");
    }

    public function index() {
        $user_sess = $this->session->userdata('AdminUser');
        
        $this->data['notification_count'] = $this->admin_model->get_notification_count();
        $this->data['notification_list'] = $this->admin_model->get_notifications_list();
        $this->data['user'] = $user_sess;
        $this->data['media_types'] = $this->mod_select->get_all('media_types');

        $this->data['caption'] = 'Add Media';
        $this->data['icon_name'] = 'fa-folder';
        $this->data['main_view'] = "cm/add_media";

        $this->load->view('cm/_layouts/template', $this->data);
    }

    // Function called by the form
    public function upload_img() {        var_dump($_FILES);exit;
