            ...
            <div class="box-body">
                <table class="table table-bordered table-striped">
                    ...
                    foreach($ccredit as $transaction):
                        ?>
                        <tr id="cash_<?php echo time(); ?>_credit">
            ...
            <div class="box-body">
                <table class="table table-bordered table-striped">
                    ...
                    foreach($bdebit as $transaction):
                        ?>
                        <tr id="bank_<?php echo time(); ?>_debit">
                            <td><?php echo date('d M, Y',strtotime($transaction['date'])) ?></td>
                            <td><?php echo $transaction['ref']; ?></td>
                            <td><?php echo $transaction['narration'] ?></td>
            ...
            <div class="box-body">
                <table class="table table-bordered table-striped">
                    ...
                    foreach($cdebit as $transaction):
                        ?>
                        <tr id="cash_<?php echo time(); ?>_debit">
                            <td><?php echo date('d M, Y',strtotime($transaction['date'])) ?></td>
                            <td><?php echo $transaction['ref']; ?></td>
                            <td><?php echo $transaction['narration'] ?></td>
                            <td> <?php echo number_format($transaction['amount'],2,'.',','); $cashbook_statement_total += $transaction['amount']; $sub += $transaction['amount']; ?></td>
            ...
            <div class="box-body">
                <table class="table table-bordered table-striped">
                    ...
                    foreach($bcredit as $transaction):
                        ?>
                        <tr id="bank_<?php echo time(); ?>_credit">
...
<div class="row">
    ...
    <div class="col-xs-6">
        <button type="button" class="btn btn-info" onclick="commit_upload();">Save Upload</button>
        <a type="button" class="btn btn-info" href="<?php echo base_url() ?>reconciliations/<?php echo $account['id'];?>">Cancel</a>
    </div>
</div>
